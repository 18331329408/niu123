...
#
# }
# money=info["小明"]["fruits"]["苹果"]+info["小明"]["fruits"]["草莓"]+info["小明"]["fruits"]["香蕉"]
# money1=info["小刚"]["fruits"]["葡萄"]+info["小刚"]["fruits"]["橘子"]+info["小刚"]["fruits"]["樱桃"]
# print("小刚gang",money1)
# print("小明ming",money)
...
list =[21,21,56,9,21,3,3,3,3,3,3,3,3,3]
def counter(list):
    return Counter(list)
print(counter(list))
